...
const RIGHTS: Right[] = [
  ...
  { label: 'Экспорт в Excel и выгрузки по расписанию', src: 'ТЗ 9, 11', cells: row(y, y, n) },
  { label: 'Утверждение и отклонение заявок', src: 'ТЗ 2, 5 — за директора решает и админ', cells: row(y, y, n), open: true },
  { label: 'Сторнирование одобренной заявки', src: 'ТЗ 5', cells: row(y, y, n) },
...
export default function RightsMatrix() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12, maxWidth: 900 }}>
      ...
      <div style={{ background: 'var(--fin-warn-soft)', borderRadius: 10, padding: '11px 14px', fontSize: 12.5, lineHeight: 1.6, color: 'var(--fin-text-2)' }}>
        <b>Открытый вопрос.</b> ТЗ (п. 5) отдаёт решение по заявкам директору и не
        говорит, что делать при его отсутствии. Сейчас утверждать может и администратор —
        иначе очередь встаёт на время отпуска. Решение принято при разработке и ждёт
